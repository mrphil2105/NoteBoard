...
namespace NoteBoard.Controllers
{
    public class BoardController : Controller
    {
        ...
        public async Task<IActionResult> GetNotes(string boardId)
        {
            var board = await _dbContext.Boards.Include(b => b.Notes)
        ...
        public async Task<IActionResult> GetOwnedNotes(string boardId)
        {
            var board = await _dbContext.Boards.Include(b => b.Notes)
                .SingleOrDefaultAsync(b => b.Id == boardId);
        ...
        [HttpPost]
        public async Task<IActionResult> CreateNote([FromHeader] string boardId, [FromBody] NoteModel model)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateNote([FromHeader] string boardId, [FromBody] NoteModel model)
        {
            if (!ModelState.IsValid ||
                string.IsNullOrWhiteSpace(model.Caption) && string.IsNullOrWhiteSpace(model.Content))
            {
